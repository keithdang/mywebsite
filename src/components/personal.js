...
import Quiz from "../images/quizwiz.png";
class PersonalProjects extends Component {
  ...
  renderWeather() {
    var infoCard = {
      ...
      componentList: [
        ...
        {
          name:
            "Determines your current location using Js Navigator for Geocoding & Nominatm for reverse Geocoding"
        },
        {
          name:
        ...
        {
          name: "Includes Unit Testing using Jest and Enzyme"
        },
        {
      ...
      linkList: [
        {
          link: "https://github.com/keithdang/geoWeather",
          title: "Go to Github!"
        }
      ],
      languageList: [
        { name: "React & Redux, Bootstrap, Javascript" },
        { name: "react-sparklines, Jest, Enzyme, Nominatm" }
      ],
      date: "Sept 22nd-25th (4 days)",
      members: "Independent",
      photo: Weather
    };
    return this.renderComponentCard(infoCard);
  ...
  renderQuiz() {
    var infoCard = {
      ...
      componentList: [
        {
          name: "Users can sign in and participate in a quiz of their choice"
        },
        {
          name:
        ...
        {
          name: "Google Auth for creation of users"
        },
        {
          name:
        ...
        {
          name: "Chart Js to display graphical content of community"
        }
      ],
      linkList: [
        {
          link: "https://quizwizkd.herokuapp.com/#",
          title: "Go to site!"
        },
        {
          link: "https://github.com/keithdang/quizwizkd",
          title: "Go to Github!"
        }
      ],
      languageList: [
        {
          name:
            "React & Redux, NodeJs, Express,Google+API, Passport, MongoDB, Bootstrap, ChartJs, Javascript"
        }
      ],
      date: "Sept 12th-13th (2 days)",
      members: "Independent",
      photo: Quiz
    };
    return this.renderComponentCard(infoCard);
  ...
  renderEmail() {
    var infoCard = {
      ...
      componentList: [
        {
          name: "Send emails to multiple addresses using SendGrid API"
        },
        {
          name:
            "Blacklist components allows adding emails you don't want to have the ability to send"
        },
        { name: "Express validator for checking text inputs" },
        { name: "MongoDB for database to check upon banned users" },
        { name: "Node JS & express for handling http requests" }
      ],
      linkList: [
        {
          link: "https://github.com/keithdang/emails",
          title: "Go to Github!"
        }
      ],
      languageList: [
        { name: "Html, Javascript (Node.js)" },
        {
          name: "Express API, MongoDB & Mongoose, SendGrid API"
        }
      ],
      date: "Sept 22nd (1 day)",
      members: "Independent",
      video: "https://www.youtube.com/embed/96ThBSO8_Ug"
    };
    return this.renderComponentCard(infoCard);
  }
  renderTournament() {
